...
class ViewController: UIViewController {
    ...
    var floatingHeaderView = HeaderReusableView()
...
extension ViewController {
    func layout() {
        //Add collection view and apply autolayout ot it
        ...
        collectionView.register(HeaderReusableView.self, forSupplementaryViewOfKind: ViewController.headerKind, withReuseIdentifier: HeaderReusableView.reuseIdentifier)
...
extension ViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let headerView = collectionView.dequeueReusableSupplementaryView(
            ofKind: ViewController.headerKind,
